...
The package also allows the flexible estimation of the cumulative hazard and cumulative survival functions, as well as the computation of aggregate measures for those (average, median, interquartile range, etc). 
