...
#> [1] "K=0, m2loglik=279.78, DOF=4, AICc=287.92, knots= 0 10"
#> [1] "K=1, m2loglik=277.87, DOF=5, AICc=288.07, knots= 0 4.9 10"
#> [1] "K=2, m2loglik=271.08, DOF=6, AICc=283.36, knots= 0 4 6 10"
#> [1] "K=3, m2loglik=270.38, DOF=7, AICc=284.76, knots= 0 3.3 4.9 6.4 10"
#> [1] "K=4, m2loglik=270.14, DOF=8, AICc=286.63, knots= 0 2.9 4.3 5.5 6.6 10"
#> [1] "K=5, m2loglik=268.59, DOF=9, AICc=287.21, knots= 0 2.5 4 4.9 6 7 10"
#> [1] "K=6, m2loglik=266.8, DOF=10, AICc=287.56, knots= 0 2 3.6 4.5 5.4 6.2 7.1 10"
#> [1] "K=7, m2loglik=266.07, DOF=11, AICc=288.98, knots= 0 1.7 3.3 4.2 4.9 5.7 6.4 7.1 10"
#> [1] "K=8, m2loglik=265.1, DOF=12, AICc=290.18, knots= 0 1.5 3 4 4.6 5.3 6 6.5 7.2 10"
#> [1] "K=9, m2loglik=265.16, DOF=13, AICc=292.43, knots= 0 1.4 2.9 3.7 4.3 4.9 5.5 6.1 6.6 7.2 10"
#> [1] "K=10, m2loglik=264.43, DOF=14, AICc=293.9, knots= 0 1.3 2.7 3.5 4.1 4.8 5.3 5.7 6.3 6.8 7.3 10"
#> [1] "K=11, m2loglik=263.18, DOF=15, AICc=294.87, knots= 0 1.2 2.5 3.3 4 4.3 4.9 5.4 6 6.4 7 7.5 10"
#> [1] "K=12, m2loglik=262.19, DOF=16, AICc=296.1, knots= 0 1.2 2.3 3.1 3.7 4.2 4.8 5.3 5.6 6.1 6.4 7 7.5 10"
#> [1] "K=13, m2loglik=260.18, DOF=17, AICc=296.35, knots= 0 1 2 2.9 3.6 4.1 4.5 4.9 5.4 5.8 6.2 6.5 7.1 7.6 10"
#> [1] "K=14, m2loglik=258.9, DOF=18, AICc=297.33, knots= 0 0.9 1.9 2.9 3.4 4 4.3 4.8 5.3 5.5 6 6.3 6.6 7.1 7.7 10"
#> [1] "SEARCH RESULT: We use 2 interior B-spline knots"
#> [1] "K= 2 DOF= 6 knots= 0 4 6 10"
